 ...
 *
 */
@TeleOp(name = "MainMovement(TeleOp)", group = "Tele-Op")
    ...
    public void runOpMode(){
     ...
     //   double intakeClaw_POSITION = intakeClaw_HOME;//Servo speed
        ...
        while (opModeIsActive()){
            ...
            double p1 = -leftStickX + leftStickY - pa;
            double p2 = leftStickX + leftStickY + -pa;
            double p3 = -leftStickX + leftStickY + pa;
            double p4 = leftStickX + leftStickY + pa;
